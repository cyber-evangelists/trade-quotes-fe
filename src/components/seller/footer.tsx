import { Box, Select, Text,  Image, Flex} from "@chakra-ui/react";
...
const Footer = () => {
    ...
    return(<Flex w={'100%'} mt={'120px'} align={'center'} justify={'center'} p={'0px 30px'} >
        <Box w={'100%'} maxWidth={'1200px'}>
            <Flex w='100%' justify={'space-between'}  mb={'50px'}  p={'30px 0px'}>
            <Flex gap={'50px'}>
            ...
            <Box w='100%' borderTop={'1px solid rgba(0, 0, 0, 0.1)'} p={'20px 0px'}>
                <Text fontWeight={'semibold'} lineHeight={'150%'} fontSize={'14px'}>Copyright © 2023 Trade Quotes.  Terms & Conditions /  Cookie policy /  Privacy policy</Text>
