      ...
      <Box py="4">
        <Flex align={"center"}  gap="4">
          ...
          <Box position='relative'  display={{base: 'block', md: 'none' }} >
            ...
            e.stopPropagation();}}  border={'1px solid #E7E9ED'} top={0} right={0} w={'90vw'} mt={'45px'} boxShadow={"0px 14px 24px rgba(13, 30, 57, 0.1)"} bg='white'  zIndex={'11'} position='absolute' rounded={'12px'} p='10px' >
